    ...
    public class GamesMetaType : ObjectGraphType<GamesMeta>
    {
        public GamesMetaType()
        {
            ...
            Field<ListGraphType<StringGraphType>>(
                "tags", 
                description: "The tags applied to this game",
                resolve: _ => ((GamesMeta)_.Source).GamesMetaTags.Select(x => x.Tag).Distinct().ToArray()
            );
            ...
            Field<ListGraphType<RankType>>(
                "rankings",
                description: "The rankings given to this game by different users",
                resolve: _ => ((GamesMeta)_.Source).GamesMetaRanks.ToArray()
            );
